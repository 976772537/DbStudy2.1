...
<div class="container-fluid">
    ...
    <div class="col-sm-8 col-sm-offset-2">
        <div class="col-sm-8">
            <form class="form-inline" action="<c:url value="/WrongBookServlet?method=getWrongBookByTime"></c:url> " method="post">
        ...
        <table class="table table-striped">
            ...
            <c:forEach var="wrongbook" items="${wrongBookList}" varStatus="loop">
                <tr>
                    <td>${testList[loop.count-1].question}</td>
                    <td>${testList[loop.count-1].score}</td>
                    <td>${wrongbook.time}</td>
                    <td>
                        <button style="margin-bottom: 10px;" type="button" class="btn btn-info"
                                data-toggle="modal"
                                data-target="#myModal${loop.count-1}">查看正确答案
                        </button>
                    </td>
                </tr>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">${testList[loop.count-1].question}</h4>
                            </div>
                            <div class="modal-body">
                                    ${testList[loop.count-1].toString()}<span><img src="<c:url value="/img/fire.png"/>"
