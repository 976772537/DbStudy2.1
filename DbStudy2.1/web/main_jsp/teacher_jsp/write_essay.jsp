...
<div class="col-sm-1  list-group" style="margin-top: 50px; margin-left: 50px; margin-right: 100px;">
    <a href="<c:url value="/main_jsp/teacher_jsp/write_essay.jsp"/> " class="list-group-item active">文章投稿</a>
...
<div class="col-sm-5">
    <div class="panel panel-default" style="margin-top: 50px">
        <div class="panel-body">
            <form action="<c:url value="/WriteEssayServlet?method=writeEssay"/> " method="post" enctype="multipart/form-data">
                <div class="col-sm-12 text-center">
                    <h1>投稿中心&nbsp;<small>文章投稿</small></h1>
                    <br>
                </div>
                <script>
                    function imgUpLoad() {
                ...
                <div class="row">
                    ...
                    <div id="upfile-div" class="col-sm-12 text-center img-upload" onclick="imgUpLoad()" style="padding:100px;">
                        <img src="<c:url value="/img/timg.png"/> " style="width: 100px;height: 75px;"
                             ><br>
                        <h1>
                            <small>添加封面图片</small>
                        </h1>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <input class="form-control" type="text" name="title" placeholder="请输入文章标题(建议30个字以内)">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <textarea class="col-sm-12" name="body"
                                  ...
                                  placeholder="请输入文章正文(限制200~2000字)"></textarea>
                    </div>
                </div>
                <hr>
                <div class="col-sm-12 text-center">
